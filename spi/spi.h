...
#define SPI_CS_BIT          PD5     /* Define SPI CS signal to be PIC port RC3 */
...
#define SPI_CS_PORT         PORTD     /* Define SPI CS signal to be PIC port RC3 */
...
#define SPI_CS_DDR          DDRD     /* Define SPI CS signal to be PIC port RC3 */
...
#define SPI_CS_PIN          PIND     /* Define SPI CS signal to be PIC port RC3 */
...
#define SOFT_SPI_CS_HIGH   SPI_CS_PORT |= (1<<SPI_CS_BIT)
#define SOFT_SPI_CS_LOW    SPI_CS_PORT &= ~(1<<SPI_CS_BIT)

#define SOFT_SPI_MISO_READ   (SPI_CS_PIN & (1<<SPI_MISO_BIT))

#define SPI_MOSI_INIT 		SPI_MOSI_DDR |= (1<<SPI_MOSI_BIT)
#define SPI_MISO_INIT 		SPI_MISO_DDR &= ~(1<<SPI_MISO_BIT)
#define SPI_CLK_INIT 		SPI_CLK_DDR |= (1<<SPI_CLK_BIT); SOFT_SPI_CLK_HIGH
#define SPI_CS_INIT 		SPI_CS_DDR |= (1<<SPI_CS_BIT); SOFT_SPI_CS_HIGH
